...
RUN apt-get update && apt-get upgrade -y &&\
	...
	apt-get install libc6 libncurses5 libstdc++6 tcsh libxext6 libx11-6 libxau6 libxdmcp6 libfreetype6 qt4-dev-tools libqtwebkit-dev libpng-tools fontconfig &&\
	mkdir ../install &&\
	cd ../install &&\
	curl -LJO "https://archive.org/download/quartus-9.1-sp2-free-linux/91sp2_quartus_free_linux.tar" &&\
