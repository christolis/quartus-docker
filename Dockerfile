...
RUN apt-get install libc6 libncurses5 libstdc++6 tcsh libxext6 libx11-6 libxau6 libxdmcp6 libfreetype6 qt4-dev-tools libqtwebkit-dev libpng-tools fontconfig -yqq
RUN mkdir ../install
RUN cd ../install
